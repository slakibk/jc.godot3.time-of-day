...
void vertex(){
	...
	v_horizon_blend = Saturate((worldPos.y - 0.03) * 3.0);
	v_scatter = AtmosphericScattering(sr, sm, mu.xy, v_angle_mult.xyz);
}
...
void fragment(){
	...
	col.rgb += deepSpace.rgb * v_horizon_blend;
